...
import { faqs, instructors } from "@/data/mockData";
          ...
          <div className="max-w-7xl mx-auto flex flex-col gap-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              {instructors.map((ins, idx) => (
                <FadeUp key={ins.id} delay={idx * 0.08} className="group bg-[#F8F4EC] rounded-2xl overflow-hidden border border-primary-sage/10 hover:shadow-lg transition-all duration-300 flex flex-col">
          ...
          <div className="max-w-3xl mx-auto flex flex-col gap-12">
            ...
            <div className="flex flex-col gap-4">
              {faqs.map((faq, idx) => {
                ...
                return (
                  <FadeUp key={faq.question} delay={idx * 0.05} className="bg-[#FCFCFA] rounded-xl border border-primary-sage/10 overflow-hidden shadow-sm">
                    <button
